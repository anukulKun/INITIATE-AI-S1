...
export function NodePalette({ nodeTypes, onAddNode }: { nodeTypes: NodeType[]; onAddNode: (id: string) => void }) {
  return (
    <aside className="w-64 bg-gradient-to-b from-black/60 via-black/50 to-black/60 border-r border-gray-800/50 backdrop-blur-md p-6 overflow-y-auto">
      <div className="mb-6">
        <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">Nodes</h3>
        <div className="h-[2px] bg-gradient-to-r from-[#39FF14]/50 via-[#39FF14]/20 to-transparent rounded-full" />
      </div>
        ...
        {nodeTypes.map((nodeType) => (
          ...
          >
            ...
            <div className="flex-1">
              <p className="text-sm font-semibold text-white group-hover:text-gray-100">{nodeType.label}</p>
